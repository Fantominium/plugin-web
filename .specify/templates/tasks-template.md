...
**Tests**: Tests are REQUIRED whenever the constitution gate matrix says they apply. Generate unit,
integration, end-to-end, regression, accessibility, contract, and migration-validation tasks whenever
the scoped change requires them.
...
- Tests required by applicable gates MUST be written and FAIL before implementation
